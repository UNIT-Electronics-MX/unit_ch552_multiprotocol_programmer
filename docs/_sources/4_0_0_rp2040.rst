...
.. tip::
    ...
    A Linux operating system is recommended, as the Pico-SDK is primarily
    developed and tested on Linux. Windows may require additional setup. macOS
    has not been tested in this documentation process.
